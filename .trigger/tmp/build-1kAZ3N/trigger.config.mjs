...
for (const envFile of [".env.local", ".env"]) {
  (0, import_dotenv.config)({ path: path.resolve(process.cwd(), envFile), override: false });
}
var projectRef = process.env.TRIGGER_PROJECT_REF || "proj_vjtmmmbsbpcyfsrwcruj";
